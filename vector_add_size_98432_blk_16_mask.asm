...
NUM_ELEMENTS = 98432, BLOCK_SIZE = 16, MASK = True
//===--LLVM IR-------------------------------------------------------------===//
...
define void @add_kernel(ptr %0, ptr %1, ptr %2, i32 %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 !dbg !3 {
  %8 = shl i32 %4, 4, !dbg !6
  %9 = insertelement <16 x i32> poison, i32 %8, i64 0, !dbg !7
  %10 = shufflevector <16 x i32> %9, <16 x i32> poison, <16 x i32> zeroinitializer, !dbg !7
  %11 = or disjoint <16 x i32> %10, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>, !dbg !7
  %12 = insertelement <16 x i32> poison, i32 %3, i64 0, !dbg !8
  %13 = shufflevector <16 x i32> %12, <16 x i32> poison, <16 x i32> zeroinitializer, !dbg !8
  %14 = icmp slt <16 x i32> %11, %13, !dbg !8
  %15 = ptrtoint ptr %0 to i64, !dbg !9
  %16 = extractelement <16 x i32> %11, i64 0, !dbg !10
  %17 = shl i32 %16, 2, !dbg !10
  %18 = sext i32 %17 to i64, !dbg !10
  %19 = add i64 %18, %15, !dbg !10
  %20 = inttoptr i64 %19 to ptr, !dbg !10
  %21 = tail call <16 x float> @llvm.masked.load.v16f32.p0(ptr %20, i32 4, <16 x i1> %14, <16 x float> zeroinitializer), !dbg !10
  %22 = ptrtoint ptr %1 to i64, !dbg !11
  %23 = add i64 %18, %22, !dbg !12
  %24 = inttoptr i64 %23 to ptr, !dbg !12
  %25 = tail call <16 x float> @llvm.masked.load.v16f32.p0(ptr %24, i32 4, <16 x i1> %14, <16 x float> zeroinitializer), !dbg !12
  %26 = fadd <16 x float> %21, %25, !dbg !13
  %27 = ptrtoint ptr %2 to i64, !dbg !14
  %28 = add i64 %18, %27, !dbg !15
  %29 = inttoptr i64 %28 to ptr, !dbg !15
  tail call void @llvm.masked.store.v16f32.p0(<16 x float> %26, ptr %29, i32 4, <16 x i1> %14), !dbg !15
  ret void, !dbg !16
}
...
.Lfunc_begin0:
	...
	vpord	.LCPI0_0(%rip), %zmm0, %zmm0
	movslq	%r8d, %rax
	vpcmpgtd	%zmm0, %zmm1, %k1
	vmovups	(%rax,%rdi), %zmm0 {%k1} {z}
	vmovups	(%rax,%rsi), %zmm1 {%k1} {z}
